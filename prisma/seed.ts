...
async function main() {
  ...
  const cmsSettings = [
    { key: "hero_slides", value: JSON.stringify(DEFAULT_HERO_SLIDES) },
    { key: "announcement_bar", value: JSON.stringify(DEFAULT_ANNOUNCEMENT_BAR) },
    { key: "editorial_looks", value: JSON.stringify(DEFAULT_EDITORIAL_LOOKS) },
    { key: "brand_story", value: JSON.stringify(DEFAULT_BRAND_STORY) },
  ];
